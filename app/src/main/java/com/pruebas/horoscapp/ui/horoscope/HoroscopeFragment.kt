...
import com.pruebas.horoscapp.ui.horoscope.adapter.HoroscopeAdapter
...
class HoroscopeFragment : Fragment() {
    ...
    private fun initUIState() {
        lifecycleScope.launch { //Se engancha al ciclo de vida del fragment, si este muere la corutina tb
